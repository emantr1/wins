...
class MessagesViewController: UIViewController {
    ...
    func filterContentForSearchText (_ searchText: String, scope: String = "All") {
        filteredMessages = commMessagesArray.filter{message in
    ...
    func refresh() {
        ...
        getMessagesQuery.whereKeyDoesNotExist("moreInfo")
        ...
        getMessagesQuery.findObjectsInBackground() { (objects, error) -> Void in
            if let objects = objects {
                commMessagesArray = emptyPFArray
                for object in objects {
                    commMessagesArray.append(object)
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        commMessagesArray = emptyPFArray
        messageCommId.append(categoryId)
    ...
    func tableView(_ tableView: UITableView!, numberOfRowsInSection section: Int) -> Int {
        ...
        return commMessagesArray.count
    }
    ...
    func setImageForCell(_ cell: ClassifiedListTableViewCell, indexPath: IndexPath) {
        ...
        let typeDetails = commMessagesArray[typeIndex]
    ...
    func setTitlesForCell(_ cell: ClassifiedListTableViewCell, indexPath: IndexPath) {
        ...
        if searchController.isActive && searchController.searchBar.text != "" {
            ...
            typeDetails = commMessagesArray[typeIndex]
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAtIndexPath indexPath: IndexPath) {
        ...
        if searchController.isActive && searchController.searchBar.text != "" {
            ...
            typeDetails = commMessagesArray[(indexPath as NSIndexPath).row]
        }
